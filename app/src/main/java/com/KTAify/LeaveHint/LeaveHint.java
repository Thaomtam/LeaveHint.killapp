...
public class LeaveHint implements IXposedHookLoadPackage {
    ...
    public void handleLoadPackage(final XC_LoadPackage.LoadPackageParam lpparam) {
        ...
        // Hook vào phương thức xử lý sự kiện tắt màn hình
        XposedHelpers.findAndHookMethod("com.android.server.power.PowerManagerService",
                lpparam.classLoader, "goToSleepNoUpdateLocked",
                long.class, int.class, int.class, int.class, new XC_MethodHook() {
                    @Override
                    protected void beforeHookedMethod(MethodHookParam param) {
                        // Khi màn hình tắt, gọi killForegroundApp
                        killForegroundApp();
                    }
                });
    }
